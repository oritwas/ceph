...
cls_method_handle_t h_rgw_bucket_journal_op;
...
int rgw_bucket_journal_op(cls_method_context_t hctx, bufferlist *in, bufferlist *out)
{
  // decode request
  ...
  CLS_LOG(1, "rgw_bucket_journal_op(): request: op=%d name=%s instance=%s tag=%s\n",
