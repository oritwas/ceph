...
public:
  ...
  int time_log_add_init(const string& log_pool, librados::IoCtx& io_ctx);
  int time_log_add(const string& log_pool, const string& oid, list<cls_log_entry>& entries,
		   librados::AioCompletion *completion, bool monotonic_inc = true);
  int time_log_add(const string& log_pool, const string& oid, const ceph::real_time& ut, const string& section,
		   const string& key, bufferlist& bl);
  int time_log_list(const string& log_pool, const string& oid, const ceph::real_time& start_time,
		    const ceph::real_time& end_time,
                    int max_entries, list<cls_log_entry>& entries,
		    const string& marker, string *out_marker, bool *truncated);
  int time_log_info(const string& log_pool, const string& oid, cls_log_header *header);
  int time_log_info_async(const string& log_pool,librados::IoCtx& io_ctx,  const string& oid, cls_log_header *header,
			  librados::AioCompletion *completion);
  int time_log_trim(const string& log_pool, const string& oid, const ceph::real_time& start_time,
		    const ceph::real_time& end_time,
  ...
  int time_log_add(const string& oid, list<cls_log_entry>& entries,
		   librados::AioCompletion *completion, bool monotonic_inc = true);
  int time_log_add(const string& oid, const ceph::real_time& ut, const string& section, const string& key,
		   bufferlist& bl);
