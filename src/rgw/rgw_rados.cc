...
const string RGW_DEFAULT_REALM_ROOT_POOL = ".rgw.root";
...
string RGWPeriod::get_latest_epoch_oid()
{
  string oid = cct->_conf->rgw_period_latest_epoch_info_oid;
  if (oid.empty()) {
    oid = period_latest_epoch_info_oid;
  }
  return oid;
}

string RGWPeriod::get_info_oid_prefix()
{
...
string RGWPeriod::get_pool_name(CephContext *cct)
{
